...
The project 42ITy uses the
https://www.gnu.org/licenses/old-licenses/gpl-2.0.en.html[GNU General Public
License v2+] license. Refer to the LICENSE file available in each 42ITy internal
sub-projects.


== Contribution Process

The project 42ITy™ adheres to the
...
IMPORTANT: 42ITy does not merge any pull requests made against a 42ITy-managed
repository until each commit has been signed for the DCO.
...
The Documentation section of the link:http://42ity.org[42ITy website] provides
some complementary technical information, such as:

* how to interact with 42ITy through the REST API
* how to create new agents for 42ITy

== Thanks and credits

A number of technical and documentation points in 42ITy™ are inspired from
...
create the foundations of the 42ITy™ project!

The 42ITy™ team also wants to thank the various projects used in the 42ITy™
